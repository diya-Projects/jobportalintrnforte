...
setTimeout(async () => {
    if (db.isMocked) {
        console.log(`====================================================`);
        console.log(`[ApexHire DB] Zero-Dependency RESILIENT FALLBACK Active.`);
        console.log(`               Using local database.json storage.`);
        console.log(`====================================================`);
    } else {
        const MONGODB_URI = db.connectionString || 'mongodb://127.0.0.1:27017/apexhire';
...
app.listen(PORT, () => {
    console.log(`====================================================`);
    console.log(`ApexHire System Server successfully initialized.`);
